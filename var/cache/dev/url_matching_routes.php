...
return [
    ...
    [ // $dynamicRoutes
        31 => [[['_route' => 'user_follow', '_controller' => 'App\\Controller\\UserController::followUser'], ['id'], ['POST' => 0], null, false, false, null]],
        ...
        244 => [
            [['_route' => 'post_like', '_controller' => 'App\\Controller\\PostController::like'], ['id'], ['POST' => 0], null, false, false, null],
