...
class __TwigTemplate_5a7d4fa9581843af5a177411d51e00d76c8089cc47b95ce4cb1ad1b876f7f560 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        ";
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                // line 18
                yield (((1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 18, $this->source); })()), "errorCount", [], "any", false, false, false, 18), 0))) ? ("sf-toolbar-status-red") : (""));
                yield "\">";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 27, $this->source); })()), "requestCount", [], "any", false, false, false, 27), 0))) ? ("disabled") : (""));
        yield "\">
    <span class=\"icon\">";
        // line 28
        yield Twig\Extension\CoreExtension::include($this->env, $context, "@WebProfiler/Icon/http-client.svg");
...
";
    ...
    ";
        // line 40
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 40, $this->source); })()), "requestCount", [], "any", false, false, false, 40), 0))) {
            // line 41
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                // line 58
                yield "                <div class=\"tab ";
                yield (((0 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 58)), 0))) ? ("disabled") : (""));
                yield "\">
                    <h3 class=\"tab-title\">";
                // line 59
                ...
                yield "</span></h3>
                    <div class=\"tab-content\">
                        ";
                // line 61
                if ((0 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 61)), 0))) {
                    // line 62
                    yield "                            <div class=\"empty\">
                        ...
                        yield "                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            ";
                        // line 102
                        if ((0 <= CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 102), 500))) {
                            // line 103
                            yield "                                                ";
                            $context["responseStatus"] = "error";
                            // line 104
                            yield "                                            ";
                        } elseif ((0 <= CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 104), 400))) {
                            // line 105
                            yield "                                                ";
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "/Users/romain/www/fairy/vendor/symfony/web-profiler-bundle/Resources/views/Collector/http_client.html.twig");
    }
}
