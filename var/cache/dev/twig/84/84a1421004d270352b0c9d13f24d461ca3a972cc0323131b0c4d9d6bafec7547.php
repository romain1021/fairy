...
class __TwigTemplate_f798f7fec0751a2cd4c5d9bcd6a7abd9928ed6de5bcf1d1ded23e9fdc3e047c4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 37, $this->source); })()), "dumpsCount", [], "any", false, false, false, 37), 0))) ? ("disabled") : (""));
        yield "\">
        <span class=\"icon\">";
        // line 38
        yield Twig\Extension\CoreExtension::include($this->env, $context, "@Debug/Profiler/icon.svg");
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/Users/romain/www/fairy/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
