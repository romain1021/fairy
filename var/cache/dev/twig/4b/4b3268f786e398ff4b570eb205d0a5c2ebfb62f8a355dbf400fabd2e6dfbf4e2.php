...
class __TwigTemplate_e574e07ac0f998134d6ddf55386d19d1e80fadd81ba76cd9ba7fa0924beccebf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        ...
        ";
        // line 71
        if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 71, $this->source); })()), "messages", [], "any", false, false, false, 71)), 0))) {
            // line 72
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/Users/romain/www/fairy/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
